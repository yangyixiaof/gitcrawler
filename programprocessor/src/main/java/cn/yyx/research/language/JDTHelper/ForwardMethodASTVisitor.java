...
public class ForwardMethodASTVisitor extends ASTVisitor {
	...
	// TODO record only assignments in a pool. reference offset is the offset to the idx of assignment in the poll at reverse order.
	...
	// TODO the offset must record which kind of sub pool it is being offset. sub pool include: final(const), class(hidden, generated by me), var or obj, or others?.
